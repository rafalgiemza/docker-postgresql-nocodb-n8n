...
- [`.ai/migrate-from-minio-to-SeaweedFS.md`](.ai/migrate-from-minio-to-SeaweedFS.md) — **wycofane**: próba migracji MinIO → SeaweedFS i powrót do MinIO (decyzja, plan, status)
