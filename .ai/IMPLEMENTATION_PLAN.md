...
| MinIO + buckety (offers/templates/recordings/transcripts/backups) — próba migracji na SeaweedFS (2026-08-08) wycofana 2026-08-26, patrz `.ai/migrate-from-minio-to-SeaweedFS.md` | ✅ gotowe; **`offers`/`templates` pozostają nieużywane** — `file-renderer-service` trzyma pliki jako NocoDB Attachment (bucket `attachments`), świadomy dług, nie rozwiązywany teraz | `scripts/minio-init.sh`, `fragments/minio-compose.yml` |
